package com.github.demonh3x.server.http.util;

import com.github.demonh3x.server.http.util.Http;
...
public class HttpBrowser {
    ...
    public String latestResponseContentAsString() {
